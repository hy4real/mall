...
public class EsProduct implements Serializable {
    ...
    public void setRecommandStatus(Integer recommandStatus) { this.recommandStatus = recommandStatus; }
    ...
    public void setNameVector(float[] nameVector) { this.nameVector = nameVector; }

    public List<EsProductAttributeValue> getAttrValueList() { return attrValueList; }
    public void setAttrValueList(List<EsProductAttributeValue> attrValueList) { this.attrValueList = attrValueList; }
}
